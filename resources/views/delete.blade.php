...
<center>
       ...
       <div class="row ">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control card" required  value="{{ $sno }}"   placeholder="Enter Sessionno" id="sessionno" name="sessionno">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control card" required  value="{{ $sessionfrom}}" placeholder="Enter Session From"  name="sessionfrom" id="sessionfrom">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control card" required  name="classname" value="{{ $sessionto }}" placeholder="Enter Class Nmae" id="classname">
    <div class="valid-feedback">Session To filled</div>
    <div class="invalid-feedback">Please fill out your Session To </div>
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control card"  required  name="comments" value="{{ $comments }}"  placeholder="Enter Remarks" id="remarks">
...
<div class="row ">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control card" required  name="enteredby"  value="{{ $enteredby }}"  placeholder="Enter EnteredBy" id="enteredby">
